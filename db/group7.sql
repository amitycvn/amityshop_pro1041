USE [master]
GO
/****** Object:  Database [PRO1041_IT18317_GROUP7]    Script Date: 11/8/2023 12:52:33 PM ******/
create DATABASE [PRO1041_IT18317_GROUP7]
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [PRO1041_IT18317_GROUP7].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET ARITHABORT OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET  ENABLE_BROKER 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET RECOVERY FULL 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET  MULTI_USER 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET DB_CHAINING OFF 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
EXEC sys.sp_db_vardecimal_storage_format N'PRO1041_IT18317_GROUP7', N'ON'
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET QUERY_STORE = OFF
GO
USE [PRO1041_IT18317_GROUP7]
GO
/****** Object:  Table [dbo].[chat_lieu]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[chi_tiet_san_pham]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[co_ao]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[gio_hang]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[gio_hang_chi_tiet]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[hoa_don]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[hoa_don_chi_tiet]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[khach_hang]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[kich_thuoc]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[mau_sac]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[nguoi_dung]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[nha_san_xuat]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[phong_cach]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[phuong_thuc_thanh_toan]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[pttt_chi_tiet]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[san_pham]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[the_loai]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[thiet_ke]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[thuong_hieu]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[voucher]    Script Date: 11/8/2023 12:52:33 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
VALUES
  ('E0E1BB52-0E25-46EE-AE31-172A225AE5BD', N'Vải cotton', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('79A0C0E6-58DD-4CB9-9A62-291DCDD216A3', N'Vải polyester', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('06C132B3-4B82-4458-BBD2-2C3A562679FF', N'Vải linen', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO co_ao (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('400C0924-7BEA-41F9-BE00-166DFCEBDD1D', N'Áo Polo Xanh', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('2CC0F887-C65E-465C-8F45-2E1BA79E0062', N'Áo Polo Đen', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('A118E52B-3503-491F-BD27-458A5BD0AEC9', N'Áo Polo Trắng', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO phong_cach (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('AD0E3863-CF41-43BE-943E-3ED09BB01664', N'Phong cách thể thao', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('766F95DE-6E98-4EDC-9697-78C923B7D115', N'Phong cách thời trang', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('E3C33DDB-8193-4C39-87AE-BB3A918A5495', N'Phong cách cổ điển', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO the_loai (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('7A6C2DA2-A4D5-454B-BB6E-473D4533D446', N'Áo Polo nam', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('1AB1145E-D246-4EDD-A63E-75EAE685DC38', N'Áo Polo nữ', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('3992E48F-1449-4D02-9F4E-F91A1FBBB719', N'Áo Polo trẻ em', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO thiet_ke (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('04C70CCC-68CC-4304-B7B5-2C2606CDEBF8', N'Thiết kế Polo cổ thấp', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('C5B45149-5F1D-4CB3-9479-B367955E940A', N'Thiết kế Polo cổ cao', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('3EA4DE49-2F20-4719-A4FA-CD6E58DECC5F', N'Thiết kế Polo tay ngắn', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO mau_sac (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('48420E14-8154-4D6C-B3F7-4E3EEB6CF817', N'Xanh', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('972B5C61-8FF0-4B29-86E0-57E8E63EF590', N'Đen', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('A926FD87-C60D-4AE3-9328-7D3BF42364CD', N'Trắng', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO san_pham (id, ma_san_pham, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('D7F63232-4A78-4C6C-81A0-B05D4BC6F44E', 'SP001', N'Áo phông', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('C5B45149-5F1D-4CB3-9479-B367955E940A', 'SP002', N'Áo polo', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('3EA4DE49-2F20-4719-A4FA-CD6E58DECC5F', 'SP003', N'Áo thun', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO nha_san_xuat (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('E150B015-1B6B-4E03-AA68-22E0140A0625', N'Sandro', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('0C10999E-5F47-48CE-8BC5-B69C3C42B4BB', N'Canifa', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('AFD3BD00-580E-4D1C-998C-C23FA2D7EED2', N'Coolmate', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO thuong_hieu (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('490CA78B-053E-4D18-883C-4A0ED0FA1FD5', N'Nike', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('4ADE83A7-624F-41D1-BE61-6D69689AF0B7', N'Adidas', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('04455736-B721-494C-9FE9-C61BA58ECD23', N'Uniqlo', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO kich_thuoc (id, ten, ngay_tao, ngay_sua, trang_thai, deleted)
VALUES
  ('92273607-79D2-4EE2-A098-C70C802AE2AD', N'Size S', '2023-10-30', '2023-10-30', N'Tốt', 0),
  ('0C141556-DCC7-4A20-AB1F-D7559252345E', N'Size M', '2023-10-31', '2023-10-31', N'Tốt', 0),
  ('44CC0AFB-77C6-41A5-BFD8-F579B5BC955E', N'Size XL', '2023-11-01', '2023-11-01', N'Tốt', 0);

INSERT INTO chi_tiet_san_pham (id, id_san_pham, id_thuong_hieu, id_mau_sac, id_the_loai, id_chat_lieu, id_kich_thuoc, id_nha_san_xuat, id_thiet_ke, id_phong_cach, id_co_ao, so_luong_ton, gia_nhap, gia_ban, ngay_nhap_kho, ngay_sua, mo_ta, trang_thai, deleted)
VALUES 
  ('FEB6B3B9-F5A7-4486-BEE3-1435536282D2', 'D7F63232-4A78-4C6C-81A0-B05D4BC6F44E', '490CA78B-053E-4D18-883C-4A0ED0FA1FD5', '48420E14-8154-4D6C-B3F7-4E3EEB6CF817', '7A6C2DA2-A4D5-454B-BB6E-473D4533D446', '79A0C0E6-58DD-4CB9-9A62-291DCDD216A3', '44CC0AFB-77C6-41A5-BFD8-F579B5BC955E', 'E150B015-1B6B-4E03-AA68-22E0140A0625', '04C70CCC-68CC-4304-B7B5-2C2606CDEBF8', 'AD0E3863-CF41-43BE-943E-3ED09BB01664', '400C0924-7BEA-41F9-BE00-166DFCEBDD1D', 100, 180000, 240000, '2023-10-30', '2023-10-31', N'Áo vip', N'Tốt', 0),
  ('AE2BD82B-E2C2-4163-A341-3D8AF4DCEC24', 'C5B45149-5F1D-4CB3-9479-B367955E940A', '490CA78B-053E-4D18-883C-4A0ED0FA1FD5', '972B5C61-8FF0-4B29-86E0-57E8E63EF590', '1AB1145E-D246-4EDD-A63E-75EAE685DC38', '79A0C0E6-58DD-4CB9-9A62-291DCDD216A3', '44CC0AFB-77C6-41A5-BFD8-F579B5BC955E', 'E150B015-1B6B-4E03-AA68-22E0140A0625', '3EA4DE49-2F20-4719-A4FA-CD6E58DECC5F', 'AD0E3863-CF41-43BE-943E-3ED09BB01664', '400C0924-7BEA-41F9-BE00-166DFCEBDD1D', 10, 450000, 540000, '2023-10-30', '2023-10-31', N'Áo xịn', N'Tốt', 0),
  ('FA696CDE-B5B8-477B-8D0F-7CD8E3FEE2F9', 'C5B45149-5F1D-4CB3-9479-B367955E940A', '4ADE83A7-624F-41D1-BE61-6D69689AF0B7', 'A926FD87-C60D-4AE3-9328-7D3BF42364CD', '7A6C2DA2-A4D5-454B-BB6E-473D4533D446', '06C132B3-4B82-4458-BBD2-2C3A562679FF', '44CC0AFB-77C6-41A5-BFD8-F579B5BC955E', 'E150B015-1B6B-4E03-AA68-22E0140A0625', '04C70CCC-68CC-4304-B7B5-2C2606CDEBF8', 'AD0E3863-CF41-43BE-943E-3ED09BB01664', '400C0924-7BEA-41F9-BE00-166DFCEBDD1D', 15, 300000, 340000, '2023-10-30', '2023-10-31', N'Áo pro', N'Tốt', 0);
...
('6CECE699-091E-4EC3-B9BE-3AE0A789E7F6', N'Chu Văn Khiếu', '0986135905', N'Xóm Thuận Trại - Xã Phú Đông - Huyện Ba Vì - TP. Hà Nội', '2023-11-08', '2023-11-08', N'Khách hàng mới', 0),
('E80586B0-63A1-4AFB-96B0-A18361C37661', N'Trần Thị Thu Hà', '0378039808', N'Xóm Thuận Trại - Xã Phú Đông - Huyện Ba Vì - TP. Hà Nội', '2023-11-08', '2023-11-08', N'Khách hàng mới', 0);
...
USE [master]
GO
ALTER DATABASE [PRO1041_IT18317_GROUP7] SET  READ_WRITE 
GO
